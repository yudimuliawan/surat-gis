			...
			<div class="card">
				<div class="card-header">
					<div class="d-flex align-items-center">
						...
						<a class="btn btn-primary btn-round ml-auto" href="{{ Route('permohonan_verlok.create') }}">
						...
						<table id="add-row" class="display table table-print table-striped table-hover" >
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<form action="{{ Route('permohonan_verlok.destroy',$e->id) }}" method="post" id="form-{{ $e->id }}">
											@csrf @method('delete')
											<div class="form-button-action">
												<input type="hidden" name="id" value="{{ $e->id }}">
												<a class="btn btn-sm btn-rounded btn-primary"  href="{{ Route('permohonan_verlok.edit',$e->id) }}">
													<i class="fa fa-edit"></i>
												</a>
												<button type="button" class="btn btn-sm btn-rounded btn-danger" onclick="confdel({{ $e->id }})">
													<i class="fa fa-times"></i>
												</button>
												<a class="btn btn-sm btn-rounded btn-primary"  href="{{ url(session('level').'/permohonan_verlok/lokasi/'.$e->id) }}">
													<i class="fa fa-map-marker-alt"></i>
												</a>

												<a class="btn btn-sm btn-rounded btn-info"  href="{{ Route('permohonan_verlok.show',$e->id) }}">
