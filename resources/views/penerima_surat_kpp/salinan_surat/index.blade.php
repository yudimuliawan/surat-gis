			...
			<div class="card">
				<div class="card-header">
					<div class="d-flex align-items-center">
						...
						<a class="btn btn-primary btn-round ml-auto" href="{{ Route('salinan_surat.create') }}">
									...
									<td>
										<form action="{{ Route('salinan_surat.destroy',$e->id) }}" method="post" id="form-{{ $e->id }}">
											...
											<div class="form-button-action">
												...
												<a class="btn btn-sm btn-rounded btn-primary"  href="{{ Route('salinan_surat.edit',$e->id) }}">
