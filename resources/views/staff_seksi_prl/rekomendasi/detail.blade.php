		...
		<div class="col-md-12">
			<div class="card">
				<div class="card-header">
					@if ($rekomendasi->is_approve==0)
					<a href="{{ url(session('level').'/rekomendasi/approve/'.$rekomendasi->id) }}" class="btn btn-info btn-round btn-sm float-right" style="float: right;">Verifikasi Surat</a>
					@else
					<span class="btn btn-success btn-round btn-sm float-right">Surat terverifikasi</span>
					@endif
