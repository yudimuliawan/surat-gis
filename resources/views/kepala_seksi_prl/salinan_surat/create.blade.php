...
<div class="page-inner">
	...
	<div class="row">
		<div class="col-md-12">
			<form action="{{ Route('salinan_surat.store') }}" method="post" enctype="multipart/form-data">
				@csrf
				<div class="card">
						...
						<div class="row">
							...
							<div class="col-sm-6">
								...
								<div class="form-group form-group-default ">
									...
									<input type="date" required="" name="tanggal_surat" class="form-control" placeholder="Masukan Tanggal Surat">
								</div>
							</div>
							<div class="col-sm-6">
								...
								<div class="form-group form-group-default ">
									...
									<input type="date" required="" name="tanggal_diterima" class="form-control" placeholder="Masukan Tanggal Diterima">
								</div>
							</div>
							<div class="col-sm-6">
								<div class="form-group form-group-default">
