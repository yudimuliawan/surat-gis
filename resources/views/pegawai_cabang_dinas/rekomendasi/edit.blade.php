...
<div class="page-inner">
	...
	<div class="row">
		<div class="col-md-12">
			<form action="{{ Route('rekomendasi.update',$data->id) }}" method="post" enctype="multipart/form-data">
				@csrf @method('patch')
				<div class="card">
						...
						<div class="row">
							...
							<div class="col-sm-6">
								<div class="form-group form-group-default ">
									...
									<select name="id_laporan_verlok" class="form-control" required="" id="id_laporan_verlok" onchange="getLaporan()">
										...
										<option {{ $data->id_laporan_verlok==$e->id ? 'selected' : '' }} value="{{ $e->id }}">{{ $e->nomor }}</option>
										@endforeach
									</select>
								</div>
							</div>
							<div class="col-sm-6">
								<div class="form-group form-group-default ">
									...
									<input type="text" required="" value="{{ $data->nomor }}" name="nomor" class="form-control" placeholder="Masukan Nomor Surat Rekomendasi" readonly="">
								</div>
							</div>
							<div class="col-sm-6">
								<div class="form-group form-group-default ">
									<label>Tanggal Surat Rekomendasi</label>
									<input type="date" required="" value="{{ $data->tanggal }}" name="tanggal" class="form-control" placeholder="Masukan Tanggal Surat Rekomendasi">
								</div>
							</div>
							...
							<div class="col-sm-4">
								<div class="form-group form-group-default">
									<label>Perihal</label>
									<input type="text" required="" value="{{ $data->perihal }}" name="perihal" class="form-control" placeholder="Masukan Perihal" id="perihal_surat">
								</div>
							</div>
							...
							<div class="col-sm-4">
								<div class="form-group form-group-default">
									...
									<input type="text" required="" name="tujuan" class="form-control" placeholder="Masukan Tujuan Surat Rekomendasi" value="{{ $data->tujuan }}" id="tujuan">
								</div>
							</div>
							...
							<div class="col-sm-4">
								<div class="form-group form-group-default">
									<label>Luas</label>
									<input type="text" required="" value="{{ $data->luas }}" name="luas" class="form-control" placeholder="Masukan Luas">
								</div>
							</div>
							<div class="col-sm-4">
								<div class="form-group form-group-default">
							...
							<div class="col-sm-12">
								<div class="form-group form-group-default">
									...
									{{-- <input type="text" required="" value="{{ $data->isi }}" name="isi" class="form-control" placeholder="Masukan Isi Surat"> --}}
								</div>
							</div>
						</div>
					</div>
